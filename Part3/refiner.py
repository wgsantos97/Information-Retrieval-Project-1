...
def main():
    ...
    revData = "../Data/graphic_novel_reviews.json"
    namData = "../Data/graphic_novels.json"
    ...
    f.write("\tShortest Entry: " + str(shortestName) +
            " - " + str(shortest) + " words \n")
    f.write("\tPositives Found: " + str(positives) + "\n")
    f.write("\tNegatives Found: " + str(negatives) + "\n")
